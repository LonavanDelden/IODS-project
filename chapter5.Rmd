...
The tea data are quite complex with 36 variables on qualitative measures. Further analysis is done with a subset of 6 variables.
...
#biplot(mca, cex = c(0.8, 1), col = c("grey40", "deeppink2"), xlab = pc_lab[1], ylab = pc_lab[2])
```
