...
K-means performed on the original Boston data and standarzied by scaling with 3 clusters. The index of accessability ro radial highways (rad) is the most influencial variable.
...
classes <- as.numeric(boston_scaled2$cluster)
plot(lda.fit, dimen = 2, col = km$cluster, pch = km$cluster)
lda.arrows(lda.fit, myscale = 1.4)
```

- Super-Bonus: (hit a dead end, no need to review any further, %*% was recognized as a non-conformable argument)
